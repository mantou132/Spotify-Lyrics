import { d as commonjsGlobal, u as updateOptions, g as getOptions, a as sendEvent, e as events, i as i18n, L as LyricsFontFamily, f as LyricsAlign, h as LyricsTransform, j as LyricsPositions, k as LyricsServer, E as Event$1, l as isWebApp, c as captureException } from "./i18n.js";
import { b as customElement, G as GemElement, h as html, d as attribute, e as boolattribute, p as property, f as refobject, g as emitter, r as render, k as kebabToCamelCase } from "./gem.js";
...
let Form = class extends GemElement {
  get elements() {
...
let FormItem = class extends GemElement {
  render() {
    return html`
      <style>
        :host {
...
let Select = class extends GemElement {
  constructor() {
    super(...arguments);
    this.options = [];
    this.inputHandler = (e) => {
...
let Switch = class extends GemElement {
  get control() {
...
let OptionsApp = class extends GemElement {
  constructor() {
    super(...arguments);
    this.state = {
      options: null,
...
OptionsApp = __decorateClass$1([
  customElement("options-app")
], OptionsApp);
const _Modal = class _Modal extends GemElement {
  constructor(content) {
    super();
    this.close = () => {
...
let OptionsModal = class extends Modal {
};
OptionsModal = __decorateClass([
  customElement("options-modal")
], OptionsModal);
window.addEventListener("message", ({ data }) => {
  if (data?.type === Event$1.OPEN_OPTIONS) {
